...
class_project = {
    ...
    "2-A": ["カジノ", "モナコ公国をモチーフに金と黒を基調とした高級カジノ", " ", "images/2-A.jpeg", "見る・遊ぶ"],
    ...
    "1-5": ["夢と希望の南国メイド喫茶「MATSU BARA🌹」", "オセアニアの文化に因んだメイド達(動物含む)がお客様をおもてなしします", "", "images/1-5.JPG", "食べる"],
    "1-6": ["らぶりーちゃんのお届けもの❤️", "南の国のらぶりーちゃんが君の心に❤️ちゅーにゅー", "", "images/1-6.jpg", "見る・遊ぶ"],
    ...
    "1-9": ["Alcatraz Cafe", "北アメリカのアルカトラズ刑務所をモチーフとしたカフェです♡", "", "images/19.jpg", "食べる"],
    "1-10": ["カニカー二のホットドッグ","スポンジボブに出てくるカニカー二のホットドッグショップです。","","images/1-10.jpeg","食べる"],
    "1-11": ["お化け屋敷", "アメリカ風のお化け屋敷です", " ", "images/1-11.png", "見る・遊ぶ"],
    "1-12": ["映画 〜おもちゃの廃墟〜", "ここは人形達が住む廃墟。一度足を踏み入れたら最後...", "", "images/1-12.png", "見る・遊ぶ"],
    ...
    "2-10": ["cafe & photospot","つぶつぶアイスなどを販売します。フォトスポットも設置します！","","images/2-10.png","見る・遊ぶ"],
    "2-11": ["アニマルカフェ","お菓子や飲み物を売ってます！！飲食できるスペースもあります！！","","images/2-11.JPG","食べる"],
    "2-12": ["たべっ子どうぶつとアフリカの旅","たべっ子動物の世界観で射的、輪投げ、ヨーヨー釣りをやります","","images/2-12.jpg","見る・遊ぶ"],
    "2-13": ["フォトスポットワカワカ","ワカワカは明るく輝くことでそんなアフリカのフォトスポットです","","images/213.JPG","見る・遊ぶ"],
    "2-14": ["青山家の谷","ミイラがたくさん出てきます。",". ","images/2-14.JPG"," "],
    "2-15": ["You can't buy hapiness cafe","アフリカの旅気分が味わえるカフェです。","  ","images/2-15.jpg"," "],
    ...
    "3-3": ["3−3‘s Sweets market","スイーツと飲み物がそろったカフェです。"," ","images/3-3.jpeg","食べる"],
    ...
    "3-11": ["南国カフェ","南国がコンセプトのカフェでドーナツとワッフル、ジュースを売ります。"," ","images/3ー11.jpg","食べる"],
...
event_project = {
   "オープニング⭐️アクト①": ["1日目", "16:00〜 体育館（中夜祭）", "教員バンド🎸", "教員７名によるバンドグループ！中夜祭のオープニングで会場を盛り上げます！", "images/教員戦隊.jpg", "体育館"],
    "新体操部①": ["1日目", "10:00〜 体育館", "Frozen", "演技「アナと雪の女王」・3年生学年演技", "images/新体操部.jpg", "体育館"],
    "チアダンス部①": ["1日目", "10:00〜 体育館", "Go! Briskly!!", "パワフルな演技をお届けします！ぜひ、見に来てください！", "images/チアダンス.jpg", "体育館"],
    "吹奏楽部①": ["1日目", "11:20〜 体育館", "SWOアイドルオーディション!", "音楽でみんなの心を掴め！きらきら輝くオーディションをお届け！", "images/吹奏楽部.jpg", "体育館"],
    "演劇・合唱①": ["1日目", "12:30〜 体育館", "Guest", "合唱部と演劇同好会の合同発表です。歌に合わせて演劇をします。ぜひみに来てください。", "images/演劇同好会.png", "体育館"],
    "軽音楽部①": ["1日目", "13:30〜 体育館", "軽音ライブ！！", "2日間にわたり、16バンドが演奏します。", "images/軽音楽部.jpg", "体育館"],
    "書道部①": ["1日目", "10:00〜 書道室", "読めない？雰囲気は分かるはず。", "書道部一同が書いた様々な形の文字をぜひご覧ください！", "images/書道部.png" , "その他"],
    "美術部①": ["1日目", "10:00〜 物理室", "物理室のアトリエ", "美術部生徒が作った作品や、バリエーション豊富な作品レクリエーションをご堪能あれ。","images/美術部.png", "その他"],
    "合唱部①": ["1日目", "10:00〜 第2音楽室", "コンサート in 第二音楽室", "今年のテーマは【宇宙人】！空からやってきたゲストと一緒に旅に出かけませんか？", "images/合唱部.jpg", "その他"],
    "電子部①": ["1日目", "10:00〜 147学習室", "電子部", "部員が作成したロボットやゲームを展示します！", "images/電子部.png", "その他"],
    "茶道部①": ["1日目", "10:00〜 作法室", "茶の湯が絆ぐ縁", "お点前で感じる“絆“の力", "images/茶道部.png", "その他"],
    "家庭科部①": ["1日目", "10:00〜 被服室", "デレラカフェ", "手作りドレスと浴衣の展示、手作りお菓子の販売。", "images/家庭科.jpg", "その他"],
    "文芸部①": ["1日目", "10:00〜 137学習室", "ことばの休憩所", "部員の作品を持ち寄って部誌にしました!休憩所としても是非!", "images/文芸部.jpg", "その他"],
    "化学部①": ["1日目", "12:30〜 生物化学室", " 虫除けスプレーを作ろう", "ハッカから天然素材を使った虫除けスプレーを作ります", "images/化学部.png", "その他"],
    "STELA1①": ["1日目", "10:00〜 STELA1", "STEAM体験", "ロボットカー・レーザーカッター体験・ゲームプログラミング講座", "images/STELA1_.png", "その他"],
    "STELA2①": ["1日目", "10:00〜 STELA2", "ポスターセッション", "STEAMコース生の探究報告から新たな発見が!!", "images/STELA2.png", "その他"],
    "STELA3①": ["1日目", "10:00〜 STELA3", " STEAM個別相談", "STEAMの個別相談を希望の方はこちらへ", "images/相談室.jpg", "その他"],
    "個別相談①": ["1日目", "10:00〜 小接室 ", " 受験生個別相談", "受験生の個別相談を希望の方はこちらへ","images/相談室.jpg", "その他"],
    
    "軽音楽部②": ["2日目", "09:15〜 体育館", "軽音ライブ！！", "2日間にわたり、16バンドが演奏します。", "images/軽音楽部.jpg", "体育館"],
    "吹奏楽部②": ["2日目", "12:00〜 体育館", "SWOアイドルオーディション!", "音楽でみんなの心を掴め！きらきら輝くオーディションをお届け！", "images/吹奏楽部.jpg", "体育館"],
    "演劇・合唱②": ["2日目", "13:10〜 体育館", "Guest", "合唱部と演劇同好会の合同発表です。歌に合わせて演劇をします。ぜひみに来てください。", "images/演劇同好会.png", "体育館"],
    "新体操部②": ["2日目", "14:00〜 体育館", "Frozen", "演技「アナと雪の女王」・3年生学年演技", "images/新体操部.jpg", "体育館"],
    "チアダンス部②": ["2日目", "14:00〜 体育館", "Go! Briskly!!", "パワフルな演技をお届けします！ぜひ、見に来てください！", "images/チアダンス.jpg", "体育館"],
    "書道部②": ["2日目", "9:00〜 書道室", "読めない？雰囲気は分かるはず。", "書道部一同が書いた様々な形の文字をぜひご覧ください！", "images/書道部.png", "その他"],
    "美術部②": ["2日目", "9:00〜 物理室", "物理室のアトリエ", "美術部生徒が作った作品や、バリエーション豊富な作品レクリエーションをご堪能あれ。","images/美術部.png", "その他"],
    "合唱部②": ["2日目", "9:00〜 第2音楽室", "コンサート in 第二音楽室", "今年のテーマは【宇宙人】！空からやってきたゲストと一緒に旅に出かけませんか？", "images/合唱部.jpg", "その他"],
    "電子部②": ["2日目", "9:00〜 147学習室", "電子部", "部員が作成したロボットやゲームを展示します！", "images/電子部.png", "その他"],
    "茶道部②": ["2日目", "9:00〜 作法室", "茶の湯が絆ぐ縁", "お点前で感じる“絆“の力", "images/茶道部.png", "その他"],
    "家庭科部②": ["2日目", "9:00〜 被服室", "デレラカフェ", "手作りドレスと浴衣の展示、手作りお菓子の販売。", "images/家庭科.jpg", "その他"],
    "文芸部②": ["2日目", "9:00〜 137学習室", "ことばの休憩所", "部員の作品を持ち寄って部誌にしました!休憩所としても是非!", "images/文芸部.jpg", "その他"],
    "化学部②": ["2日目", "12:30〜 生物化学室", " 虫除けスプレーを作ろう", "ハッカから天然素材を使った虫除けスプレーを作ります", "images/化学部.png", "その他"],
    "STELA1②": ["2日目", "9:00〜 STELA1", "STEAM体験", "ロボットカー・レーザーカッター体験・ゲームプログラミング講座", "images/STELA1_.png", "その他"],
    "STELA2②": ["2日目", "9:00〜 STELA2", "ポスターセッション", "STEAMコース生の探究報告から新たな発見が!!", "images/STELA2.png", "その他"],
    "STELA3②": ["2日目", "9:00〜 STELA3", " STEAM個別相談", "STEAMの個別相談を希望の方はこちらへ", "images/相談室.jpg", "その他"],
    "個別相談②": ["2日目", "9:00〜 小接室", " 受験生個別相談", "受験生の個別相談を希望の方はこちらへ","images/相談室.jpg", "その他"],
}
...
def event_list_page():
    ...
    for name, (event_day, time_place, summary, _, _, cate) in event_project.items():
