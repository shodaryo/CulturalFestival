...
class_project = {
    ...
    "1-9": ["Alcatraz Cafe", "北アメリカのアルカトラズ刑務所をモチーフとしたカフェです♡", "", " ", "食べる"],
    "2-10": [" "," ","","",""],
    ...
    "2-3": ["アラビアンナイトカフェ","お菓子や飲み物などを販売します。またアラビアンな店員がおもてなしや対応したりする。","  ","images/","見る・遊ぶ"],
    ...
    "3-11": ["南国カフェ","南国がコンセプトのカフェでドーナツとワッフル、ジュースを売ります。"," "," ","食べる"],
