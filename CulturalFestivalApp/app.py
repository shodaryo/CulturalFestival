...
#1年生　※1年1〜3組は合同です（検索時にまとめてヒットするようにしてください）
    ...
    "2-13": ["フォトスポットワカワカ","ワカワカは明るく輝くことでそんなアフリカのフォトスポットです","","images/2ー13.jpg","見る・遊ぶ"],
    "2-14": ["青山家の谷","ミイラがたくさん出てきます。",". ","images/2ー14.jpg"," "],
    "2-15": ["You can`t buy happiness Cafe","アフリカの旅気分が味わえるカフェです。","  ","images/2ー15.jpg"," "],
    ...
    "3-13": ["カフェ・サンバってる!?","サンバ衣装のメイドが接客、写真撮影ができる南米風メイド喫茶"," ","images/3ー13.jpg","見る・遊ぶ"],
