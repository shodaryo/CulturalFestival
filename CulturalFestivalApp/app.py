...
event_project = {
   "新体操部①": ["1日目", "10:00〜 体育館", "Frozen", "演技「アナと雪の女王」・3年生学年演技", "images/新体操部.jpg", "体育館"],
    ...
    "化学部①": ["1日目", "10:00〜 生化室", " 虫除けスプレーを作ろう", "ハッカから天然素材を使った虫除けスプレーを作ります", "images/化学部.png", "その他"],
    ...
    "化学部②": ["2日目", "9:00〜 生化室", " 虫除けスプレーを作ろう", "ハッカから天然素材を使った虫除けスプレーを作ります", "images/化学部.png", "その他"],
